...
# copied from https://nixos.org/nix/install 2023-11-29, modified to "work" offline
# changes:
# - skip tarball download (L101-103)
# - set tarball path to match file passed into template (L86)
# issues:
# - cannot initialize nixpkgs channel while offline, workaround added in .bashrc
...
# rewrite tarball location
tarball=/home/user/Downloads/nix-2.19.1-$system.tar.xz
